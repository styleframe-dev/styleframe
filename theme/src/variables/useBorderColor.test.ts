...
describe("useBorderColor", () => {
	...
	it("should return all border color variables in an object", () => {
		const s = styleframe();
		const borderColors = useBorderColor(s, {
			default: "#e5e5e5",
			primary: "#3b82f6",
			success: "#10b981",
		});
	...
	it("should compile individual border color variable to correct CSS", () => {
		const s = styleframe();
		const { borderColorPrimary } = useBorderColor(s, {
			primary: "#3b82f6",
		});
	...
	it("should not create duplicate variables when called multiple times", () => {
		const s = styleframe();
		const borderColors1 = useBorderColor(s, {
			default: "#e5e5e5",
			primary: "#3b82f6",
		});
		const borderColors2 = useBorderColor(s, {
			default: "#e5e5e5",
			primary: "#3b82f6",
		});
	...
	describe("default border color", () => {
		it("should create a default border color variable with the provided value", () => {
			const s = styleframe();
			const { borderColor } = useBorderColor(s, {
				default: "#e5e5e5",
			});
