...
describe("useDuration", () => {
	...
	it("should create duration variable with modifier for non-default keys", () => {
		const s = styleframe();
		const { durationFast } = useDuration(s, {
			fast: "150ms",
		});
	...
	describe("type safety", () => {
		...
		it("should work with const assertion", () => {
			...
			const durations = useDuration(s, durationConfig);
