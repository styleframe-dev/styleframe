export const borderColorValues = {
	...
	warning: "@color.warning-shade-100",
	danger: "@color.danger-shade-100",
	info: "@color.info-shade-100",
} as const;
...
export const hoverBorderColorValues = {
	...
	"warning.hover": "@color.warning-shade-150",
	"danger.hover": "@color.danger-shade-150",
	"info.hover": "@color.info-shade-100",
} as const;
...
export const darkModeBorderColorValues = {
	...
	warning: "@color.warning-tint-100",
	danger: "@color.danger-tint-100",
	info: "@color.info-tint-100",
} as const;
...
export const darkModeHoverBorderColorValues = {
	...
	"warning.hover": "@color.warning-tint-150",
	"danger.hover": "@color.danger-tint-150",
	"info.hover": "@color.info-tint-150",
} as const;
