...
:::
:::tabs-item{icon="i-lucide-code" label="base.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="extension.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="colors.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="typography.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="spacing.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="override.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="custom.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="dark-theme.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="high-contrast-theme.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="tokens.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="semantic.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="components.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="animations.ts"}
...
:::
:::tabs-item{icon="i-lucide-code" label="dark-mode.ts"}
