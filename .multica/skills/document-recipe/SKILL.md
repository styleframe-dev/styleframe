...
- **Full color** (9 colors — badge, button, callout, chip): `apps/docs/content/docs/05.components/04.feedback/00.badge.md`
- **Container color** (3 colors — card, modal, tooltip): `apps/docs/content/docs/05.components/07.layout/03.card.md`
- **Minimal color / multi-recipe**: `apps/docs/content/docs/05.components/04.feedback/05.spinner.md`
...
- [ ] File written to `apps/docs/content/docs/05.components/<category-dir>/<nn>.<name>.md`.
