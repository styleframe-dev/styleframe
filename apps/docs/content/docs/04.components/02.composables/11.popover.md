...
The Popover combines the structured layout of a [Card](/docs/components/composables/card) (header, body, footer sections) with the directional arrow of a [Tooltip](/docs/components/composables/tooltip). The recipes integrate directly with the default [design tokens preset](/docs/design-tokens/presets) and generate type-safe utility classes at build time with zero runtime CSS.
