...
._outline-style\:dotted {
	outline-style: dotted;
}
._outline-style\:double {
	outline-style: double;
}

._outline-color\:primary {
...
```html
<button class="_ring:2 _ring-color:primary">Button with focus ring</button>
...
const { colorGray200 } = useColorDesignTokens(s, {
	gray200: "#e5e7eb",
} as const);
