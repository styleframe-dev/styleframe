...
._box-shadow-color\:primary {
	--tw-shadow-color: var(--color--primary);
}
._box-shadow-color\:black {
...
._mix-blend-mode\:color-burn {
	mix-blend-mode: color-burn;
}
._mix-blend-mode\:hard-light {
	mix-blend-mode: hard-light;
}
._mix-blend-mode\:soft-light {
	mix-blend-mode: soft-light;
}
._mix-blend-mode\:difference {
	mix-blend-mode: difference;
}
._mix-blend-mode\:exclusion {
	mix-blend-mode: exclusion;
}
._mix-blend-mode\:hue {
	mix-blend-mode: hue;
}
._mix-blend-mode\:saturation {
	mix-blend-mode: saturation;
}
._mix-blend-mode\:color {
	mix-blend-mode: color;
}
._mix-blend-mode\:luminosity {
...
```html
<div
	class="_background-blend-mode:multiply"
	style="background: url(image.jpg), blue;"
>
...
```html
<div
	class="_box-shadow _hover:box-shadow:lg"
