...
<img
	class="_grayscale:0"
	src="image.jpg"
	alt="Full color (removes grayscale)"
/>
```
...
```html
<div class="_backdrop-blur:md _bg:white/50">Frosted glass panel</div>
<nav class="_backdrop-blur:lg">Blurred navigation background</nav>
```
