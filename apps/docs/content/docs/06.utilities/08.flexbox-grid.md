...
```html
<div class="_display:grid _grid-flow:dense">Dense auto-placement grid</div>
```
...
<div class="_display:grid _gap-x:lg _gap-y:sm">
...
```html
<div
	class="_display:grid _grid-cols:1 _gap:md md:_grid-cols:2 lg:_grid-cols:3 lg:_gap:lg"
>
	<div>Card 1</div>
	<div>Card 2</div>
	<div>Card 3</div>
...
```html
<div
	class="_display:flex _justify:center _align-items:center"
	style="height: 100vh;"
>
