...
```html
<table class="_border-collapse:collapse">
	Merged borders
</table>
<table class="_border-collapse:separate">
	Separate borders
</table>
```
...
._border-spacing-x\:0 {
	...
	border-spacing: 0 var(--tw-border-spacing-y);
}
._border-spacing-x\:2 {
	--tw-border-spacing-y: 0;
...
._border-spacing-y\:0 {
	...
	border-spacing: var(--tw-border-spacing-x) 0;
}
._border-spacing-y\:2 {
	--tw-border-spacing-x: 0;
...
```html
<table
	class="_border-collapse:collapse _table-layout:fixed"
	style="width: 100%;"
>
	<thead>
		<tr>
