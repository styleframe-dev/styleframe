...
:root {
	...
	--font-size--sm: 0.875rem;
	--font-size--md: calc(
		(var(--font-size--min) / 16 * 1rem) + (var(--font-size--max) - 16) *
			var(--fluid--breakpoint)
	);
}
...
```html
<h1
	class="_font-size:4xl _font-weight:bold _line-height:tight _letter-spacing:tight"
>
	Page Title
</h1>
