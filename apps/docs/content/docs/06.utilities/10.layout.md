...
```html
<nav class="_z-index:sticky">Sticky navbar</nav>
...
```html
<div class="_position:fixed _inset:0 _z-index:modal _display:flex">
...
```html
<header class="_position:sticky _top:0 _z-index:sticky">
    Navigation content
</header>
```
