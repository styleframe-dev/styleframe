...
._margin\:1\.5 {
	margin: calc(var(--spacing, 1rem) * 1.5);
}
._margin\:2 {
	margin: calc(var(--spacing, 1rem) * 2);
}
._margin\:0\.5 {
	margin: calc(var(--spacing, 1rem) * 0.5);
}
._margin\:-1 {
	margin: calc(var(--spacing, 1rem) * -1);
}
```
...
const { spacing, spacingSm, spacingMd, spacingLg, spacingXl } =
...
const { spacingSm, spacingMd, spacingLg, spacingXl } = useSpacingDesignTokens(
	s,
	{
		sm: "0.5rem",
		md: "1rem",
