...
._background-image\:gradient-primary {
	background-image: linear-gradient(to right, #006cff, #00b4d8);
}
._background-image\:gradient-dark {
...
._background-repeat\:round {
	background-repeat: round;
}
._background-repeat\:space {
...
```css [styleframe/index.css]
._background-clip\:border {
	background-clip: border-box;
}
._background-clip\:padding {
	background-clip: padding-box;
}
._background-clip\:content {
...
<h1
	class="_background-clip:text _background-image:gradient-primary"
...
```css [styleframe/index.css]
._background-origin\:border {
	background-origin: border-box;
}
._background-origin\:padding {
	background-origin: padding-box;
}
._background-origin\:content {
...
```html
<section
	class="_background-image:hero _background-size:cover _background-position:center _background-repeat:no-repeat"
>
