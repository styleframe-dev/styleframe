...
[Learn more about the Fluid Viewport →](/docs/design-tokens/composables/fluid-design/viewport)
...
[Learn more about Clamp Functions →](/docs/design-tokens/composables/fluid-design/viewport)
...
```ts [styleframe.config.ts]
import { styleframe } from 'styleframe';
import { useFluidViewport, useFluidFontSize, useScaleDesignTokens, useScalePowersDesignTokens } from '@styleframe/theme';
...
- **New to fluid design?** Begin with [Clamp Function](/docs/design-tokens/composables/fluid-design/viewport) to understand the foundation
- **Building fluid typography?** Check out [Fluid Typography](/docs/design-tokens/composables/fluid-design/typography) for complete type systems
- **Want mathematical consistency?** Learn about [Scales](/docs/design-tokens/composables/scales) for harmonious proportions
- **Combining with fixed tokens?** Explore [Typography](/docs/design-tokens/composables/typography) for hybrid approaches
