...
**Good to know:** While `useScalePowersDesignTokens()` generates the multipliers, you'll typically want to use them with [`useMultiplierDesignTokens()`](#usemultiplier) to create properly named variables for your design system.
