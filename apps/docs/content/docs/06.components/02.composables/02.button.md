...
The recipe includes a `:focus-visible` style that displays a 2px solid outline in the primary color with a 2px offset. This ring appears only during keyboard navigation, not on mouse clicks, following the [WCAG 2.4.7 (Focus Visible)](https://www.w3.org/WAI/WCAG21/Understanding/focus-visible.html) guideline.
