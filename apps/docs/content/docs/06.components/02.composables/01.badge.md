...
Badges often communicate status or category through color alone. To meet [WCAG 1.4.1 (Use of Color)](https://www.w3.org/WAI/WCAG21/Understanding/use-of-color.html), color must not be the only visual means of conveying information.
