...
The Chip recipes integrate directly with the default [design tokens preset](/docs/design-tokens/presets) and generate type-safe utility classes at build time with zero runtime CSS.
