---
title: W3C Design Tokens Community Group (DTCG)
...
The output is consumable by any DTCG-compatible tool — including Tokens Studio, Style Dictionary, and the Styleframe Figma plugin (which performs DTCG → Figma value conversion). For the full Figma round-trip workflow, see the [Figma Plugin](/docs/getting-started/integrations/figma-plugin) page.
