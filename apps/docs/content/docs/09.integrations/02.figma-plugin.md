...
| Option           | Alias | Default                | Description                                              |
| ---------------- | ----- | ---------------------- | -------------------------------------------------------- |
| `--input`        | `-i`  | _required_             | Input `.tokens.json` file or directory of per-mode files |
...
::tip
Learn more about the DTCG format at [designtokens.org](https://www.designtokens.org/){target="\_blank"}.
::
