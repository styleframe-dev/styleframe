...
<h2
	class="_before:background-color:primary _before:width:full _before:height:px"
>
	Section Title
</h2>
```
...
<div class="_after:background-color:overlay">Content with overlay</div>
```
...
```html
<p
	class="_first-letter:font-size:3xl _first-letter:font-weight:bold _first-letter:text-color:primary"
>
