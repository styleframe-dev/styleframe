---
title: Media & Preferences Modifiers
...
._background-color\:surface {
	background-color: #ffffff;
}
._background-color\:surface-dark {
	background-color: #1a1a2e;
}
._text-color\:body {
	color: #212529;
}
._text-color\:body-light {
	color: #e2e8f0;
}
...
```html
<body
	class="_background-color:surface _dark:background-color:surface-dark _text-color:body _dark:text-color:body-light"
>
...
::tabs
:::tabs-item{icon="i-lucide-file-input" label="Output for [dark, hover]"}
...
<div class="_motion-safe:transition-duration:300">Animated content</div>
```
...
<main class="_print:background-color:white">Printable content</main>
```
...
```html
<div
	class="_background-color:surface _dark:background-color:surface-dark _text-color:body _dark:text-color:body-dark _motion-safe:transition-duration:200 _motion-reduce:transition-duration:0"
>
	Adaptive content
</div>
```
