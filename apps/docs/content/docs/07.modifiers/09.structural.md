...
**Part of the Modifiers Preset:** `useStructuralModifiers` is included in the [Modifiers Preset](/docs/theme/modifiers/presets) (`useModifiersPreset`) and you can configure it through the preset's `structural` option. For most projects, applying it via the preset is the recommended approach.
::
