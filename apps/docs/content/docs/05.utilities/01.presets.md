...
| `config` | `UtilitiesPresetConfig` | Optional configuration for customizing utility defaults |
...
|--------|------|-------------|
| `meta.merge` | `boolean` | When true, custom values merge with defaults |
| `flex` | `false \| Record<string, string>` | Flex utility values |
| `flexDirection` | `false \| Record<string, string>` | Flex direction values |
| `flexWrap` | `false \| Record<string, string>` | Flex wrap values |
| `justifyContent` | `false \| Record<string, string>` | Justify content values |
| `alignItems` | `false \| Record<string, string>` | Align items values |
| `display` | `false \| Record<string, string>` | Display values |
| `position` | `false \| Record<string, string>` | Position values |
| `cursor` | `false \| Record<string, string>` | Cursor values |
| `textAlign` | `false \| Record<string, string>` | Text align values |
| ... | ... | [See all options](#configuration-options-reference) |
