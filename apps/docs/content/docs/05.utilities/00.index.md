...
When working with [recipes](/docs/api/recipes), you need to register utility factories before defining your recipes. The `useDefaultUtilitiesPreset()` function registers all 200+ utility factories in a single call:
...
const utilities = useDefaultUtilitiesPreset(s);
