...
Control the stacking order of elements. For a consistent stacking scale, use the [z-index design tokens](/docs/theme/design-tokens/composables/z-index) which provide semantic names like `dropdown`, `modal`, and `toast`.
