...
import { useFillUtility } from "@styleframe/theme/utilities";
...
import { styleframe } from "styleframe";
import { useColor } from "@styleframe/theme";
import { useStrokeUtility } from "@styleframe/theme/utilities";
...
```ts [styleframe.config.ts]
import { styleframe } from "styleframe";
import { useStrokeWidthUtility } from "@styleframe/theme/utilities";
...
import { styleframe } from "styleframe";
import { useColor } from "@styleframe/theme";
import { useFillUtility, useStrokeUtility } from "@styleframe/theme/utilities";
