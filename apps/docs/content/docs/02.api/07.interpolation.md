...
::warning
Do not use interpolation for simple static values. While there is no runtime cost, interpolated values can limit certain compile-time optimizations that Styleframe applies to tokenized values.
::
