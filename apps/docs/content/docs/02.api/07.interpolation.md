...
const fontSize = variable('font-size.default', '16px');
...
.text {
    font: var(--font-size--default)/var(--line-height--normal) var(--font-family--sans);
    text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.1), 0 0 1em var(--font-size--default);
}
```
