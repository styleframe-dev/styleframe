...
[Learn more about Instances →](/docs/api/instance)
...
[Learn more about Selectors →](/docs/api/selectors)
...
[Learn more about At-Rules →](/docs/api/at-rules)
...
[Learn more about Media Queries →](/docs/api/media-queries)
...
const s = styleframe();
const { keyframes, selector, css } = s;
...
[Learn more about Keyframes →](/docs/api/keyframes)
...
selector(".gradient", {
	background: css`linear-gradient(135deg, ${colorPrimary} 0%, ${colorSecondary} 100%)`,
	padding: css`clamp(${spacingSm}, 5vw, ${spacingLg})`,
});
```

[Learn more about Interpolation →](/docs/api/interpolation)
...
createMarginUtility({ sm: "0.5rem", md: "1rem", lg: "1.5rem" }, [hover]);
```
...
Utility modifiers transform utility declarations to create conditional variations based on hover states, media queries, and more. Build composable utility variants with full type safety.

**Key capabilities:**

- Transform utility declarations with conditions
- Create responsive breakpoint modifiers
- Support multi-key modifiers for mutually exclusive states
- Combine multiple modifiers for complex scenarios
...
[Learn more about Modifiers →](/docs/api/utility-modifiers)
...
[Learn more about Themes →](/docs/api/themes)
...
```ts [variables/useColorVariables.ts]
...
[Learn more about Composables →](/docs/api/composables)
...
[Learn more about Merging →](/docs/api/merging)
...
| [Modifiers](/docs/api/utility-modifiers) | Conditional utility variants   | Hover, focus, responsive         |
...
- **Need utilities?** Learn about [Utilities](/docs/api/utilities) and [Modifiers](/docs/api/utility-modifiers)
