...
These exports are wired to the `virtual:styleframe` import specifier through a generated `.styleframe/tsconfig.json`, which your project's `tsconfig.json` extends:
...
The companion `.styleframe/shims.d.ts` declares the `virtual:styleframe.css` module.
