...
selector('.animated-element', {
    animation: `${fadeInKeyframes.rule} 0.3s ease-out`,
});
...
selector('.interactive-button', {
    ...
    '&:hover': {
        animation: css`${buttonHoverKeyframes.rule} ${ref(animationDurationFast)} ease-out`,
    },
});
...
selector('.modal', {
    animation: `${slideInMobileKeyframes.rule} 0.3s ease-out`,
});

media('(min-width: 768px)', ({ selector }) => {
    selector('.modal', {
        animation: `${slideInDesktopKeyframes.rule} 0.4s ease-out`,
    });
});
...
selector('.animate-pulse', {
    animation: `${pulseKeyframes.rule} 2s cubic-bezier(0.4, 0, 0.6, 1) infinite`,
});

selector('.animate-spin', {
    animation: `${spinKeyframes.rule} 1s linear infinite`,
});

selector('.animate-shake', {
    animation: `${shakeKeyframes.rule} 0.82s cubic-bezier(0.36, 0.07, 0.19, 0.97)`,
});
...
selector('.progress-bar', {
    ...
    '&.active': {
        animation: `${expandWidthKeyframes.rule} 2s ease-out forwards`,
    },
});
...
selector('.notification', {
    ...
    '&.show': {
        animation: `${fadeInUpKeyframes.rule} 0.4s ease-out forwards`,
    },
    
    '&.hide': {
        animation: `${fadeInUpKeyframes.rule} 0.4s ease-out reverse`,
    },
});
...
selector('.bouncing-button', {
    animation: `${bounceKeyframes.rule} 0.6s infinite`,
});
