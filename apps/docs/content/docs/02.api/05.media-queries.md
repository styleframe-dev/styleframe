...
const s = styleframe();
const { variable, ref, selector, css } = s;

const breakpointSm = variable('breakpoint.sm', '576px');
const breakpointMd = variable('breakpoint.md', '992px');
const breakpointLg = variable('breakpoint.lg', '1200px');
