...
The Placeholder recipe integrates directly with the default [design tokens preset](/docs/theme/design-tokens/presets) and generates type-safe utility classes at build time with zero runtime CSS.
...
:::story-preview
---
story: theme-recipes-layout-placeholder--default
panel: true
---
:::
