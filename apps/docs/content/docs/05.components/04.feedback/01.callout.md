...
const {
	...
	CalloutProps & { title?: string; description?: string; dismissible?: boolean }
>();
...
<div
	class="callout _display:flex _padding:md _border-width:thin ..."
	role="alert"
>
...
story: theme-recipes-feedback-callout--default
panel: true
...
story: theme-recipes-feedback-callout--info
panel: true
...
## story: theme-recipes-feedback-callout--all-variants
...
| `error`     | `@color.error`                   | Error messages, destructive warnings, critical alerts      |
...
story: theme-recipes-feedback-callout--solid
panel: true
...
story: theme-recipes-feedback-callout--outline
panel: true
...
story: theme-recipes-feedback-callout--soft
panel: true
...
story: theme-recipes-feedback-callout--subtle
panel: true
...
story: theme-recipes-feedback-callout--large
panel: true
...
## story: theme-recipes-feedback-callout--all-sizes
...
story: theme-recipes-feedback-callout--horizontal
panel: true
...
story: theme-recipes-feedback-callout--vertical
panel: true
...
## story: theme-recipes-feedback-callout--all-orientations
...
- **Choose colors by meaning, not appearance**: Use `success` for confirmations, `error` for errors, and `warning` for caution messages &mdash; this keeps your UI consistent when tokens change.
