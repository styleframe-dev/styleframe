...
|------|-----------|---------------|
| `xs` | `@font-size.3xs` | `@border-radius.sm` |
| `sm` | `@font-size.2xs` | `@border-radius.sm` |
| `md` | `@font-size.xs` | `@border-radius.md` |
| `lg` | `@font-size.sm` | `@border-radius.md` |
| `xl` | `@font-size.md` | `@border-radius.md` |
