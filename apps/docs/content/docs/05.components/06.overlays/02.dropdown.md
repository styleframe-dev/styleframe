...
<template>
	<div role="menu" :class="dropdown({ color, variant, size })">
		...
		<button
			type="button"
			role="menuitem"
			:class="dropdownItem({ color, variant, size })"
		>
			Profile
		</button>
		<button
...
<div class="dropdown-wrapper">
	<div role="menu" class="dropdown _background:neutral _border-radius:md ...">
		<div role="presentation" class="dropdown-label _color:muted ...">
			Account
		</div>
		<button type="button" role="menuitem" class="dropdown-item _padding:sm ...">
			Profile
		</button>
		<button type="button" role="menuitem" class="dropdown-item _padding:sm ...">
			Settings
		...
		<hr
			role="separator"
			class="dropdown-separator _border-top-width:thin ..."
		/>
		<button type="button" role="menuitem" class="dropdown-item _padding:sm ...">
			Sign out
		</button>
...
story: theme-recipes-overlays-dropdown--default
panel: true
...
story: theme-recipes-overlays-dropdown--light
panel: true
...
story: theme-recipes-overlays-dropdown--all-variants
height: 480
...
story: theme-recipes-overlays-dropdown--solid
panel: true
...
story: theme-recipes-overlays-dropdown--soft
panel: true
...
story: theme-recipes-overlays-dropdown--subtle
panel: true
...
story: theme-recipes-overlays-dropdown--large
panel: true
...
story: theme-recipes-overlays-dropdown--all-sizes
height: 520
...
<div class="dropdown-wrapper">
	<div role="menu" class="dropdown(...)">
		...
		<button type="button" role="menuitem" class="dropdownItem(...)">
			Profile
		</button>
		<button type="button" role="menuitem" class="dropdownItem(...)">
			Settings
