...
The Popover combines the structured layout of a [Card](/docs/theme/components/card) (header, body, footer sections) with the directional arrow of a [Tooltip](/docs/theme/components/tooltip). The recipes integrate directly with the default [design tokens preset](/docs/theme/design-tokens/presets) and generate type-safe utility classes at build time with zero runtime CSS.
