...
<template>
	<div role="menu" :class="contextMenu({ color, variant, size })">
		...
		<button
			type="button"
			role="menuitem"
			:class="contextMenuItem({ color, variant, size })"
		>
			Reload
...
const destructiveClasses = contextMenuItem({
	...variants,
	destructive: "true",
});
...
<div role="menu" class="context-menu _background:neutral ...">
	...
	<button
		type="button"
		role="menuitem"
		class="context-menu-item context-menu-item--destructive-true ..."
	>
		Delete
	</button>
</div>
...
| Part            | Recipe                             | Role                                                                                                                                                                                     |
| --------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Panel**       | `useContextMenuRecipe()`           | Outer wrapper with background, border, border radius, shadow, `z-index: @z-index.dropdown`, and a `max-width` cap (`@12`&ndash;`@18`) so long labels wrap instead of stretching the menu |
...
<button
	...
	role="menuitemcheckbox"
	aria-checked="true"
	class="contextMenuItem({ inset: 'true' })"
>
	<span class="context-menu-item-indicator" aria-hidden="true">✔</span>
	Show Bookmarks
</button>
...
<div role="menu" aria-label="Page actions" class="...">
	...
	<button type="button" role="menuitemcheckbox" aria-checked="true" class="...">
		Show Grid
	</button>
