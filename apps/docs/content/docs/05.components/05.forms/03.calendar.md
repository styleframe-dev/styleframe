...
The Calendar recipes integrate directly with the default [design tokens preset](/docs/theme/design-tokens/presets) and generate type-safe utility classes at build time with zero runtime CSS.
...
// → "calendar-day -selected _aspect-ratio:[1 / 1] ..."
```
	...
	<div class="calendar-month">
		...
		<div class="calendar-grid">
			...
			<div class="calendar-week">
				<button class="calendar-day -selected ...">18</button>
				<!-- … -->
			</div>
		</div>
	</div>
