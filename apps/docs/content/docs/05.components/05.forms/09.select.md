...
<template>
	<div>
		...
		>
			...
			>
				{{ value }}
				<button type="button" class="select-chip-remove" aria-label="Remove">
					&times;
				</button>
			</span>
		...
		<ul
			v-if="open"
			role="listbox"
			:class="selectPanel({ color, variant: 'solid', size })"
		>
			<li
...
const panelClasses = selectPanel({
	color: "neutral",
	variant: "solid",
	size: "md",
});
...
const optionClasses = selectOption({
	color: "neutral",
	variant: "solid",
	size: "md",
});
...
>
	<span class="select-chip ..."
		>Apple<button class="select-chip-remove" aria-label="Remove">
			&times;
		</button></span
	>
	<span class="select-chip ..."
		>Banana<button class="select-chip-remove" aria-label="Remove">
			&times;
		</button></span
	>
...
<div class="select(...)" role="combobox" aria-expanded="true">
	<span class="selectChip(...)"
		>Apple<button class="select-chip-remove">&times;</button></span
	>
	<span class="selectArrow(...)">▾</span>
</div>
...
<ul class="selectPanel(...)" role="listbox">
	...
	<li class="selectOption(...)" role="option" aria-selected="true">
		<span class="select-icon">🍎</span>Apple<span class="select-option-check"
			>✓</span
		>
	</li>
