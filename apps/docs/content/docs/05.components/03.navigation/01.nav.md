...
const { orientation = "horizontal", size = "md" } = defineProps<NavProps>();
</script>
...
<nav
	class="nav _display:flex _flex-direction:row ..."
	aria-label="Main navigation"
>
	<a href="/" class="nav-item _padding:sm ...">Home</a>
	<a href="/about" class="nav-item _padding:sm ..." aria-current="page"
		>About</a
	>
</nav>
```
...
story: theme-recipes-navigation-nav--default
panel: true
...
story: theme-recipes-navigation-nav--vertical
panel: true
...
story: theme-recipes-navigation-nav--dark
panel: true
...
## story: theme-recipes-navigation-nav--all-variants
...
story: theme-recipes-navigation-nav--ghost
panel: true
...
story: theme-recipes-navigation-nav--link
panel: true
...
story: theme-recipes-navigation-nav--large
panel: true
...
## story: theme-recipes-navigation-nav--all-sizes
...
story: theme-recipes-navigation-nav--active
panel: true
...
story: theme-recipes-navigation-nav--disabled
panel: true
...
<nav aria-label="Main navigation" class="...">
	<a href="/" class="...">Home</a>
	<a href="/about" class="navItem({ active: 'true' })" aria-current="page"
		>About</a
	>
</nav>
