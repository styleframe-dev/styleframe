...
<nav aria-label="Breadcrumb" class="breadcrumb _display:flex _gap:sm ...">
	...
	<span class="breadcrumb-item _font-weight:semibold ..." aria-current="page"
		>Current page</span
	>
</nav>
```
...
story: theme-recipes-navigation-breadcrumb--default
panel: true
...
story: theme-recipes-navigation-breadcrumb--neutral
panel: true
...
## story: theme-recipes-navigation-breadcrumb--all-variants
...
## story: theme-recipes-navigation-breadcrumb--all-sizes
...
story: theme-recipes-navigation-breadcrumb--active
panel: true
...
story: theme-recipes-navigation-breadcrumb--disabled
panel: true
...
story: theme-recipes-navigation-breadcrumb--custom-separator
panel: true
...
<nav
	...
	class="..."
	style="--breadcrumb--separator-content: '\203A'"
>
	<a class="..." href="/">Home</a>
...
<nav aria-label="Breadcrumb" class="breadcrumb(...)">
	...
	<span class="breadcrumbItem({ active: 'true' })" aria-current="page"
		>Current Page</span
	>
</nav>
```
...
<a
	href="#"
	class="breadcrumbItem({ disabled: 'true' })"
	aria-disabled="true"
	tabindex="-1"
>
	Restricted
