...
<button
	class="button _border-width:thin _cursor:pointer _background:neutral ..."
>
	Click me
</button>
```
...
## story: theme-recipes-actions-button--all-variants
...
| `error`     | `@color.error`                   | Destructive actions, error states, alerts         |
...
story: theme-recipes-actions-button--solid
panel: true
...
story: theme-recipes-actions-button--outline
panel: true
...
story: theme-recipes-actions-button--soft
panel: true
...
story: theme-recipes-actions-button--subtle
panel: true
...
story: theme-recipes-actions-button--ghost
panel: true
...
story: theme-recipes-actions-button--link
panel: true
...
story: theme-recipes-actions-button--extra-large
panel: true
...
## story: theme-recipes-actions-button--all-sizes
...
story: theme-recipes-actions-button--disabled
panel: true
...
- **Choose colors by meaning, not appearance**: Use `success` for positive actions and `error` for destructive actions &mdash; this keeps your UI consistent when tokens change.
...
const button = useButtonRecipe(s, {
	...
	compoundVariants: [
		{
			match: { color: "brand", variant: "solid" },
			css: { background: "@color.brand", color: "@color.white" },
		},
		{
			match: { color: "brand", variant: "outline" },
			css: { color: "@color.brand", borderColor: "@color.brand" },
		},
