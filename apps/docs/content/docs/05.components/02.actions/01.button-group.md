...
The Button Group recipe integrates directly with the [Button recipe](/docs/theme/components/button) and generates type-safe utility classes at build time with zero runtime CSS.
...
:::story-preview
---
story: theme-recipes-actions-button-group--default
panel: true
---
:::
...
::story-preview
---
story: theme-recipes-actions-button-group--horizontal
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--vertical
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--all-orientations
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--block
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--block-vertical
panel: true
---
::
...
The Button Group works with all [Button color variants](/docs/theme/components/button#colors). Each button within the group retains its own color styling while the group handles layout and border collapsing.

::story-preview
---
story: theme-recipes-actions-button-group--primary
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--all-variants
---
::
...
The Button Group showcases how each [Button visual style](/docs/theme/components/button#variants) looks when buttons are joined together. Border collapsing is most visible with variants that have explicit borders, like `outline` and `subtle`.
...
::story-preview
---
story: theme-recipes-actions-button-group--solid
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--outline
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--soft
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--subtle
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--ghost
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--link
panel: true
---
::
...
The Button Group works with all [Button sizes](/docs/theme/components/button#sizes). All buttons within a group should use the same size for consistent alignment.

::story-preview
---
story: theme-recipes-actions-button-group--extra-large
panel: true
---
::
...
::story-preview
---
story: theme-recipes-actions-button-group--all-sizes
---
::
...
- **Pair with the Button recipe**: The Button Group recipe targets child elements with the `.button` class. Always use it alongside the [Button recipe](/docs/theme/components/button) for consistent border collapsing.
