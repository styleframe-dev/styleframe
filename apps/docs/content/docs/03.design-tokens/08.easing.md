...
.modal {
	transition:
		opacity 0.3s var(--easing--ease-out-cubic),
...
const { easing, easingEnter, easingExit, easingEmphasize } =
	useEasingDesignTokens(s, {
...
selector(".notification", {
	animation: css`
		${fadeIn} 0.5s ${easingBounce} forwards
	`,
});

selector(".tooltip", {
	animation: css`
		${fadeIn} 0.3s ${easingSpring} forwards
	`,
});
