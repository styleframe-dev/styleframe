...
const { zIndex, zIndexBase, zIndexDropdown, zIndexModal, zIndexToast } =
	useZIndexDesignTokens(s, {
...
const { zIndexDropdown, zIndexOverlay, zIndexModal, zIndexToast } =
	useZIndexDesignTokens(s);

// Create matching shadow scale
const { boxShadowMd, boxShadowLg, boxShadowXl, boxShadow2xl } =
...
:root {
	...
	--z-index--toast: 600;
	--box-shadow--md:
		0 2px 4px oklch(var(--box-shadow-color, 0 0 0) / 0.16),
		0 8px 16px -4px oklch(var(--box-shadow-color, 0 0 0) / 0.1);
	--box-shadow--lg:
		0 4px 8px oklch(var(--box-shadow-color, 0 0 0) / 0.18),
		0 16px 24px -8px oklch(var(--box-shadow-color, 0 0 0) / 0.12);
	--box-shadow--xl:
		0 8px 12px oklch(var(--box-shadow-color, 0 0 0) / 0.2),
		0 24px 48px -12px oklch(var(--box-shadow-color, 0 0 0) / 0.14);
	--box-shadow--2xl:
		0 12px 16px oklch(var(--box-shadow-color, 0 0 0) / 0.22),
		0 32px 64px -16px oklch(var(--box-shadow-color, 0 0 0) / 0.16);
}
