---
title: Box Shadows Design Tokens
...
:root {
	...
	--box-shadow--xs:
		0 1px 1px oklch(var(--box-shadow-color, 0 0 0) / 0.12),
		0 2px 2px -1px oklch(var(--box-shadow-color, 0 0 0) / 0.06);
	--box-shadow--sm:
		0 1px 2px oklch(var(--box-shadow-color, 0 0 0) / 0.14),
		0 3px 6px -1px oklch(var(--box-shadow-color, 0 0 0) / 0.1);
	--box-shadow--md:
	...
	--box-shadow--inner:
		inset 0 1px 0 oklch(var(--box-shadow-color, 0 0 0) / 0.08),
		inset 0 0 0 1px oklch(var(--box-shadow-color, 0 0 0) / 0.06);
	--box-shadow--ring:
		0 0 0 1px oklch(var(--box-shadow-color, 0 0 0) / 0.12),
		0 1px 2px oklch(var(--box-shadow-color, 0 0 0) / 0.08);
...
The `useBoxShadowDesignTokens()` function creates a set of box shadow variables for establishing visual elevation and depth in your interface.
...
const { boxShadow, boxShadowNone, boxShadowSm, boxShadowMd, boxShadowLg } =
	useBoxShadowDesignTokens(s, {
...
:root {
	--box-shadow--none: none;
	--box-shadow--sm:
		0 1px 1px oklch(0 0 0 / 0.12), 0 2px 2px -1px oklch(0 0 0 / 0.06);
	--box-shadow--md:
		0 2px 4px oklch(0 0 0 / 0.16), 0 8px 16px -4px oklch(0 0 0 / 0.1);
	--box-shadow--lg:
		0 4px 8px oklch(0 0 0 / 0.18), 0 16px 24px -8px oklch(0 0 0 / 0.12);
	--box-shadow: var(--box-shadow--md);
}
```
...
selector(".btn", {
	...
	"&:focus-visible": {
		boxShadow: css`
			${boxShadowButton}, ${boxShadowFocus}
		`,
	},
});
...
:root {
	...
	--box-shadow--none: none;
	--box-shadow--card:
		0 1px 3px oklch(var(--box-shadow-color) / 0.12),
		0 1px 2px oklch(var(--box-shadow-color) / 0.06);
	--box-shadow--button:
		0 1px 2px oklch(var(--box-shadow-color) / 0.14),
		0 2px 4px oklch(var(--box-shadow-color) / 0.1);
	--box-shadow--dropdown:
		0 4px 6px oklch(var(--box-shadow-color) / 0.16),
		0 10px 20px -4px oklch(var(--box-shadow-color) / 0.1);
	--box-shadow--modal:
		0 8px 16px oklch(var(--box-shadow-color) / 0.18),
		0 20px 40px -8px oklch(var(--box-shadow-color) / 0.12);
	--box-shadow--drawer:
		0 12px 24px oklch(var(--box-shadow-color) / 0.2),
		0 30px 60px -12px oklch(var(--box-shadow-color) / 0.14);
	--box-shadow--toast:
		0 16px 32px oklch(var(--box-shadow-color) / 0.22),
		0 40px 80px -16px oklch(var(--box-shadow-color) / 0.16);
...
:root {
	...
	--box-shadow--none: none;
	--box-shadow--xs:
		0 1px 1px oklch(var(--box-shadow-color) / 0.12),
		0 2px 2px -1px oklch(var(--box-shadow-color) / 0.06);
	--box-shadow--sm:
		0 1px 2px oklch(var(--box-shadow-color) / 0.14),
		0 3px 6px -1px oklch(var(--box-shadow-color) / 0.1);
	--box-shadow--md:
		0 2px 4px oklch(var(--box-shadow-color) / 0.16),
		0 8px 16px -4px oklch(var(--box-shadow-color) / 0.1);
	--box-shadow--lg:
		0 4px 8px oklch(var(--box-shadow-color) / 0.18),
		0 16px 24px -8px oklch(var(--box-shadow-color) / 0.12);
	--box-shadow: var(--box-shadow--md);
}
...
const { colorPrimary, colorSuccess, colorWarning, colorError } =
...
const { boxShadowPrimary, boxShadowSuccess, boxShadowWarning, boxShadowError } =
	useBoxShadowDesignTokens(s, {
...
:::accordion-item{label="Why use useBoxShadowDesignTokens instead of writing shadows directly?" icon="i-lucide-circle-help"}
`useBoxShadowDesignTokens()` centralizes your shadow system, making it easy to maintain consistency and update shadows globally. It also enables powerful features like dynamic shadow colors through `--box-shadow-color`, theme-aware shadows, and semantic naming that makes your intent clear.
:::
