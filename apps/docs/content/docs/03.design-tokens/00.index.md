...
- **`useFluidFontSizeDesignTokens()`**: Create complete fluid typography systems with modular scales
...
const { fontSize, fontSizeSm, fontSizeMd, fontSizeLg } = useFluidFontSizeDesignTokens(s, 
