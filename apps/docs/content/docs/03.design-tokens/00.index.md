...
- **`useColorLevelDesignTokens()`**: Generate levels (e.g., 50, 100, 200...950)
...
[Learn more about Easing →](/docs/theme/design-tokens/composables/easing)
...
**Available composables:**
- **`useFluidViewportDesignTokens()`**: Define viewport range (min/max widths) and calculate the fluid breakpoint variable
- **`useFluidClamp()`**: Generate fluid `calc()` calculations for any CSS property
- **`useFontSizeDesignTokens()`**: Font-size variables — tuple/object values become fluid clamps, plain values stay static
...
// Tuple = absolute pixel range, clamped between min/max viewport widths.
// Plain values stay static. References (`@...`) work too.
...
[Learn more about Fluid Design →](/docs/theme/design-tokens/composables/fluid-design)
...
[Learn more about Z-Index →](/docs/theme/design-tokens/composables/z-index)
...
| **Colors** | `useColorDesignTokens`, `useColorLevelDesignTokens`, `useColorShadeDesignTokens`, `useColorTintDesignTokens` | Define colors and generate variants |
...
- **New to design tokens?** Begin with [Colors](/docs/theme/design-tokens/composables/colors) and [Spacing](/docs/theme/design-tokens/composables/spacing)
- **Building a type system?** Check out [Typography](/docs/theme/design-tokens/composables/typography) and [Scales](/docs/theme/design-tokens/composables/scales)
- **Creating visual hierarchy?** Explore [Box Shadows](/docs/theme/design-tokens/composables/box-shadows), [Z-Index](/docs/theme/design-tokens/composables/z-index), and [Borders](/docs/theme/design-tokens/composables/borders)
- **Working on responsive design?** Learn about [Breakpoints](/docs/theme/design-tokens/composables/breakpoints)
