...
const containerSm = variable(
	"container.sm",
	useFluidClamp(s, { min: 320, max: 640 }),
);
const containerMd = variable(
	"container.md",
	useFluidClamp(s, { min: 640, max: 960 }),
);
const containerLg = variable(
	"container.lg",
	useFluidClamp(s, { min: 960, max: 1280 }),
);
const containerXl = variable(
	"container.xl",
	useFluidClamp(s, { min: 1280, max: 1600 }),
);
