...
**Part of the Design Tokens Preset:** Fluid font sizing is enabled by default in the [Design Tokens Preset](/docs/theme/design-tokens/presets) (`useDesignTokensPreset`) and you can configure it through the preset's `fluidFontSize` and `fluidScale` options. For most projects, applying it via the preset is the recommended approach.
::
...
- **[Line Height](/docs/theme/design-tokens/typography#uselineheight)**: Create proportional line heights
