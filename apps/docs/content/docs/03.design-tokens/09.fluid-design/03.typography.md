...
:root {
	...
	--font-size--md: calc(
		(16 / 16 * 1rem) + (18 - 16) * var(--fluid--breakpoint)
	);
	--font-size--lg: calc(
		(18 / 16 * 1rem) + (24 - 18) * var(--fluid--breakpoint)
	);
...
useFontSizeDesignTokens(s, {
	...
	default: "@font-size.md",
	xs: [
		"@font-size.min * @scale.min-powers.-2",
		"@font-size.max * @scale.max-powers.-2",
	],
	sm: [
		"@font-size.min * @scale.min-powers.-1",
		"@font-size.max * @scale.max-powers.-1",
	],
	md: [
		"@font-size.min * @scale.min-powers.0",
		"@font-size.max * @scale.max-powers.0",
	],
	lg: [
		"@font-size.min * @scale.min-powers.1",
		"@font-size.max * @scale.max-powers.1",
