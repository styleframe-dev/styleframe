...
const colorPrimaryLevels = useColorLevelDesignTokens(s, colorPrimary, {
	...colorLevelValues,
	150: 0.8, // Add 150 level
	250: 0.7, // Add 250 level
	350: 0.6, // Add 350 level
	450: 0.5, // Add 450 level
} as const);
...
const colorPrimaryTints = useColorTintDesignTokens(
	s,
	colorPrimary,
	defaultColorTintValues,
);
...
const { colorSecondaryShade100 } = useColorShadeDesignTokens(
	s,
	colorSecondary,
	{
		100: 10,
