...
const { borderStyle, borderStyleWavy, borderStyleHidden } =
	useBorderStyleDesignTokens(s, {
		default: "solid",
...
const { borderWidth, borderWidthHairline, borderWidthBold, borderWidthHeavy } =
	useBorderWidthDesignTokens(s, {
		default: "1px",
		hairline: "0.5px",
		bold: "2px",
...
// Define base colors
const { colorGray, colorPrimary, colorSuccess, colorError } =
...
const { colorGray300, colorGray500, colorGray700 } = useColorLevelDesignTokens(
	s,
	colorGray,
	{
		300: 35,
...
const { borderColor, borderColorLighter, borderColorDarker } =
	useBorderColorDesignTokens(s, {
...
// Setup base colors
const { colorGray, colorPrimary, colorSuccess, colorWarning, colorError } =
	useColorDesignTokens(s, {
		gray: "#d1d5db",
		primary: "#3b82f6",
		success: "#10b981",
