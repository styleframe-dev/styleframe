...
useFontSizeDesignTokens(s, {
    default: '@font-size.md',
    xs: ['16 * @scale.min-powers.-2', '18 * @scale.max-powers.-2'],
    sm: ['16 * @scale.min-powers.-1', '18 * @scale.max-powers.-1'],
    md: [16, 18],
    lg: ['16 * @scale.min-powers.1', '18 * @scale.max-powers.1'],
    xl: ['16 * @scale.min-powers.2', '18 * @scale.max-powers.2'],
});
```
