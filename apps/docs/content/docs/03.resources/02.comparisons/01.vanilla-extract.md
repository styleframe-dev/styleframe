...
- **Dual output**: From one `.styleframe.ts` file, you get both static CSS *and* typed TypeScript runtime functions (e.g., recipe functions with full IDE autocomplete).
