...
title: Create a Design System with styleframe in Under 15 minutes
to: /docs/getting-started/guides/create-design-system-in-under-15-minutes
---
...
to: /docs/getting-started/guides/theme-switcher
---
